...
public class PacketDataSerializerReimpl extends ByteBuf {

    private final ByteBuf source;

    public PacketDataSerializerReimpl(ByteBuf source) {
        this.source = source;
    }

    public PacketDataSerializerReimpl writeVarInt(int i) {
        while ((i & -128) != 0) {
    ...
    public PacketDataSerializerReimpl writeByteArray(byte[] bs) {
    ...
    public PacketDataSerializerReimpl writeUUID(UUID uUID) {
